...
public class Tc_14_Otherbank_Transfer_RTGS  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC14b";
		testDescription="Otherbank_Transfer-RTGS";
		browserName="Chrome";
	...
	.clickInitiatetrans()
	.clickOtherPayeeTab()
	.submitOtherbankAccForm( accno,name,fromacc,amount, remarks,"RTGS")
	.otpVerify(otp)
	.clickOkTransfer()
